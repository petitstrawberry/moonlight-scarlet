{
  description = "Moonlight client for Scarlet";
    ...
    let
      ...
      mkSystem = system:
        let
          ...
          nativeTools = [ pkgs.cmake pkgs.llvmPackages.clang pkgs.llvmPackages.libclang pkgs.pkg-config ];
          ...
          runtimeTools = [ rustToolchain cargo-scarlet-plugin-limine pkgs.git pkgs.curl ] ++ nativeTools ++ imageTools;
